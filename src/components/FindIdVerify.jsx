...
export function FindIdVerify({ onNext, onBack, email = "0000@gmail.com" }) {
    ...
    return (
        <div className="find-id-container">
            ...
            {/* Main Content */}
            <div className="find-id-main-title">아이디를 찾기 위해<br/>이메일을 인증해주세요</div>

            {/* Email Section (Readonly) */}
            <div className="find-id-label" style={{ top: '275px' }}>이메일</div>
            ...
            <div className="find-id-action-btn btn-white" style={{ top: '298px' }}>
                <div>다시 받기</div>
            </div>

            {/* Verification Code Section */}
            <div className="find-id-label" style={{ top: '369px' }}>인증번호</div>
            <div className="find-id-input-container" style={{ top: '392px' }}>
                <input 
                    type="text" 
            ...
            <div className="find-id-action-btn btn-amber" style={{ top: '392px' }} onClick={onNext}>
                <div>인증확인</div>
            </div>

             <div className="timer-text" style={{ top: '455px' }}>남은 시간 2:59</div>
        </div>
    );
}
