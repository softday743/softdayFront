    ...
    return (
        <div className="folder-container">
            <div className="folder-scroll-area">
                ...
                <div className="section-label" style={{ top: '93px' }}>오늘의 내 기분은?</div>
                ...
                {/* Stress Index Trend */}
                <div className="section-label" style={{ top: '240px' }}>스트레스 지수 추이 그래프</div>
                ...
                <div className="section-label" style={{ top: '375px' }}>스트레스 원인 분석</div>
                ...
                <div className="section-label" style={{ top: '635px' }}>시간대별 스트레스 분포</div>
