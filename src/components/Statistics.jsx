  ...
  return (
    <div className="statistics-container">
      ...
      <div className="stat-analysis-card">
        <div className="stat-analysis-content-title">
          업무 과다가 가장 많았어요
        </div>
        ...
        <div className="stat-pie-chart">
          ...
          >
            <circle cx="40" cy="50" r="40" fill="#FDBA74" stroke="none" />{" "}
            {/* Orange part placeholder */}
            <circle
              cx="40"
              cy="50"
              r="30"
            ...
            />{" "}
            {/* Purple part placeholder - simplified */}
            {/* Legend */}
            <g transform="translate(120, 20)">
              ...
              <text x="20" y="42" fontSize="12" fill="black">
                성과압박
              </text>

              <circle cx="8" cy="68" r="4" fill="#97CA72" />
              <text x="20" y="72" fontSize="12" fill="black">
                인간관계
              </text>
            </g>
            {/* Percentages */}
            <text x="20" y="50" fontSize="10" fill="white">
              35%
            </text>
            <text x="50" y="30" fontSize="10" fill="white">
              50%
            </text>
          </svg>
        </div>
      ...
      <div className="stat-time-card">
        <div className="stat-time-chart">
          ...
          >
            ...
            <path
              d="M0.5 76.5V23.5L20 20.5L40 5.5L55 9L77 17.5L97 32L120 25.5L140 22.5L160 30L178 37.5L198 49L218 56.5L237 61L263 70.5L288 76.5H0.5Z"
              fill="#FFF9EA"
              stroke="#FD9800"
