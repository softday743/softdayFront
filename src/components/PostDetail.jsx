...
export function PostDetail({ onBack }) {
    ...
    const isOverlayVisible = reportStep === 'confirm' || reportStep === 'complete' || blockStep === 'confirm' || blockStep === 'complete';
    ...
    return (
        <div className="post-detail-container">
            ...
            <div className="pd-scroll-area">
                ...
                {reportStep === 'category' && (
                    <div className="pd-reason-list">
                        <div className="pd-reason-item" onClick={() => handleCategorySelect('스팸/부적절한 홍보')}>스팸/부적절한 홍보</div>
                        <div className="pd-reason-item" onClick={() => handleCategorySelect('욕설/비하 발언')}>욕설/비하 발언</div>
                        <div className="pd-reason-item" onClick={() => handleCategorySelect('음란물/유해 정보')}>음란물/유해 정보</div>
                        <div className="pd-reason-item" onClick={() => handleCategorySelect('개인정보 노출')}>개인정보 노출</div>
                        <div className="pd-reason-item" onClick={() => handleCategorySelect('기타')}>기타</div>
                    </div>
                )}
                ...
                {reportStep === 'confirm' && (
                    <div className="pd-confirm-popup">
                        ...
                        <div className="pd-confirm-desc">신고 이유 상세 조건 안내<br/>정말 신고하시겠습니까?</div>
                        <div className="pd-confirm-actions">
                            <div className="pd-confirm-btn" onClick={handleCancelReport}>취소</div>
                            <div className="pd-confirm-btn" onClick={handleConfirmReport} style={{ background: '#fef3c7', border: '1px solid #fcd34d' }}>확인</div>
                        </div>
                    </div>
                )}
                ...
                {blockStep === 'confirm' && (
                    <div className="pd-confirm-popup">
                        ...
                        <div className="pd-confirm-desc">차단 안내 사항<br/>정말 차단하시겠습니까?</div>
                        <div className="pd-confirm-actions">
                            <div className="pd-confirm-btn" onClick={handleCancelBlock}>취소</div>
                            <div className="pd-confirm-btn" onClick={handleConfirmBlock} style={{ background: '#fef3c7', border: '1px solid #fcd34d' }}>확인</div>
                        </div>
                    </div>
                )}
                ...
                <div className="pd-eye-icon">
                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.671875 8.06213C0.671875 8.06213 3.35919 2.6875 8.06199 2.6875C12.7648 2.6875 15.4521 8.06213 15.4521 8.06213C15.4521 8.06213 12.7648 13.4368 8.06199 13.4368C3.35919 13.4368 0.671875 8.06213 0.671875 8.06213Z" stroke="#959595" strokeWidth="1.79154" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M8.06199 10.0776C9.17512 10.0776 10.0775 9.17526 10.0775 8.06213C10.0775 6.94901 9.17512 6.04665 8.06199 6.04665C6.94887 6.04665 6.04651 6.94901 6.04651 8.06213C6.04651 9.17526 6.94887 10.0776 8.06199 10.0776Z" stroke="#959595" strokeWidth="1.79154" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                </div>
            ...
            <div className="pd-comment-input-container">
                ...
                <input type="text" className="pd-input-placeholder" placeholder="댓글을 달아주세요" />
