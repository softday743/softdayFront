...
export function ProfileSaved({ onBack }) {
    ...
    const [savedPosts, setSavedPosts] = useState([
        { id: 1, title: '제목', content: '내용', category: '직장생활', author: '작성자 정보', time: '시간(ex, n분 전)', likeCount: '좋아요', commentCount: '댓글', viewCount: '조회수', icon: '🖥️' },
    ...
    return (
        <div className="ps-container">
            ...
            <div className="ps-tabs-container">
                ...
                <div 
                    className={`ps-tab ${activeTab === 'contents' ? 'active' : 'inactive'}`}
            ...
            <div className="ps-list-bg">
                ...
                {activeTab === 'contents' && savedContents.map(item => (
                    <div key={item.id} className="ps-content-card">
                        ...
                        <div className="ps-content-bookmark">
                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21.25 18.75L15.125 14.375L9 18.75V4.75C9 4.28587 9.18437 3.84075 9.51256 3.51256C9.84075 3.18437 10.2859 3 10.75 3H19.5C19.9641 3 20.4092 3.18437 20.7374 3.51256C21.0656 3.84075 21.25 4.28587 21.25 4.75V18.75Z" fill="#FECB17" stroke="#FECB17" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </div>
                    </div>
                ))}
