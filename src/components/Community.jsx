            ...
            <div className="community-scroll-area">
                ...
                <div className="community-post-list">
                    {currentPosts.map(post => (
                        <div key={post.id} className="community-post-card" onClick={() => onNavigate('postDetail')} style={{cursor: 'pointer'}}>
                            <div className="cp-header">
                                ...
                                <div className="cp-author">{post.author}</div>
                                <div className="cp-time">{post.time}</div>
                            </div>
                            ...
                            <div className="cp-footer">
                                ...
                                <div className="cp-stat-item">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12.0833 2.25C14.725 2.25 16.5 4.76438 16.5 7.11C16.5 11.8603 9.13333 15.75 9 15.75C8.86667 15.75 1.5 11.8603 1.5 7.11C1.5 4.76438 3.275 2.25 5.91667 2.25C7.43333 2.25 8.425 3.01781 9 3.69281C9.575 3.01781 10.5667 2.25 12.0833 2.25Z" stroke={post.hasLikes ? "#FF3737" : "#959595"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                    <span className={post.hasLikes ? 'has-count' : ''}>{post.likes > 0 ? post.likes : '좋아요'}</span>
                                </div>
                                {/* Comment */}
                                <div className="cp-stat-item">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.75 9C15.75 12.7279 12.7279 15.75 9 15.75C8.10214 15.75 7.24523 15.5747 6.46162 15.2565C6.31164 15.1955 6.23666 15.1651 6.17604 15.1515C6.11675 15.1382 6.07286 15.1334 6.0121 15.1333C5.94998 15.1333 5.88231 15.1446 5.74699 15.1672L3.07857 15.6119C2.79914 15.6585 2.65942 15.6818 2.55839 15.6384C2.46996 15.6005 2.3995 15.53 2.36157 15.4416C2.31824 15.3406 2.34152 15.2009 2.3881 14.9214L2.83283 12.253C2.85539 12.1177 2.86666 12.05 2.86666 11.9879C2.86665 11.9271 2.86179 11.8833 2.8485 11.824C2.83491 11.7633 2.80446 11.6884 2.74355 11.5384C2.4253 10.7548 2.25 9.89786 2.25 9C2.25 5.27208 5.27208 2.25 9 2.25C12.7279 2.25 15.75 5.27208 15.75 9Z" stroke={post.comments > 0 ? "#2EC1C9" : "#959595"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                    <span className={post.comments > 0 ? 'has-comments' : ''}>{post.comments > 0 ? post.comments : '댓글'}</span>
                                </div>
                                {/* View */}
                                <div className="cp-stat-item">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="pagination">
                    ...
                    {Array.from({ length: totalPages }, (_, i) => (
                        <button
                            key={i + 1}
                            className={`page-btn number ${currentPage === i + 1 ? 'active' : ''}`}
