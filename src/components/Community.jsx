    ...
    return (
        <div className="community-container">
            ...
            <div className="community-header">
                <div className="tab-item active">전체</div>
                <div className="tab-item">직장 생활</div>
                <div className="tab-item">인간관계</div>
                <div className="tab-item">취미/여가</div>
            </div>
            ...
            <div className="community-scroll-area">
                ...
                <div className="community-post-list">
                    {/* Post 1 */}
                    <div className="community-post-card" onClick={() => onNavigate('postDetail')} style={{cursor: 'pointer'}}>
                        <div className="cp-header">
                            ...
                            <div className="cp-category-badge">
                                <div className="cp-category-text">카테고리</div>
                            </div>
                            <div className="cp-author">작성자 정보</div>
                            <div className="cp-time">시간(ex, n분 전)</div>
                        </div>
                        <div className="cp-title">제목</div>
                        <div className="cp-content">내용</div>
