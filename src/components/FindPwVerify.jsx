...
export function FindPwVerify({
  ...
  return (
    <div className="find-id-container">
      ...
      <div
        className="find-id-input-container wide"
        style={{
          top: "298px",
          background: "white",
      ...
      <div className="find-id-label" style={{ top: "365px" }}>
        이메일
      </div>
      <div
        className="find-id-input-container"
        style={{
          top: "388px",
      ...
      {/* Verification Code */}
      <div className="find-id-label" style={{ top: "455px" }}>
        인증번호
      </div>
      ...
      <div className="timer-text" style={{ top: "541px" }}>
        남은 시간 2:59
      </div>
    </div>
  );
